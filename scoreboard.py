...
class Scoreboard:
    ...
    def prep_high_score(self):
        ...
        self.high_score_rect.left = self.screen_rect.left + 30
    ...
    def prep_cats(self):
        ...
        for cat_number in range(self.stats.cats_left):
            cat = Cat(self.ai_game)
            cat.image = pygame.image.load('images/mini_branches.bmp')
            cat.rect.centerx = 750 + cat_number * cat.rect.width / 2
            cat.rect.y = 10
            self.cats.add(cat)
